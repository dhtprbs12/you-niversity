...
class MentorRevisionView: UIView{
    ...
    override func updateConstraints() {
        if(shouldSetupConstraints){
            ...
            //middleSchoolButton.autoPinEdge(.left, to: .right, of: elementaryButton, withOffset: 5)
            //highSchool
            ...
            //collegeButton.autoPinEdge(.left, to: .right, of: highSchoolButton, withOffset: 5)
            //MentoringField
            ...
            //delete button
            deleteButton.autoPinEdge(.top, to: .bottom, of: mentoringInfoTextView, withOffset: 10)
            deleteButton.autoPinEdge(toSuperviewEdge: .left, withInset: 5)
            deleteButton.autoPinEdge(toSuperviewEdge: .right, withInset: 5)
            //save button
            saveButton.autoPinEdge(.top, to: .bottom, of: deleteButton, withOffset: 10)
            saveButton.autoPinEdge(toSuperviewEdge: .left, withInset: 5)
            saveButton.autoPinEdge(toSuperviewEdge: .right, withInset: 5)
    ...
    func initUI(){
        ...
        //backgroundImage.image = UIImage(named: "stanford")
        ...
        univTextField.placeholder = " Ex):University of Arizona"
        ...
        majorTextField.placeholder = " Ex):Computer Science"
        ...
        maximumMentoringField.text = "2 items at least"
        ...
        mentorIntroTextView.placeholder = "Please, introduce yourself in detail"
        ...
        mentoringInfoTextView.placeholder = "Please, explain us how are you able to be a good mentor"
        ...
        deleteButton.setTitleColor(App.mainColor, for: .normal)
        ...
        saveButton.backgroundColor = App.mainColor
